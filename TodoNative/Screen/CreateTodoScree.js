...
import {insert} from '../redux/reducer';

const CreateTodoScree = ({navigation, route}) => {
            ...
            <View style={styles.topViewAlign}>
              <View style={styles.topViews}>
                <View style={styles.topViewContents}>
                  <Text style={styles.todoStyle}>Create Todo</Text>
                </View>
              </View>
            </View>
        </View>
...
export default CreateTodoScree